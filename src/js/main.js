...
$(function() {
    ...
    function(a) {
        ...
        initTooltips("*[data-toggle=tooltip]"), a(document).on("click", ".footer-links-user .links--panel-list li i", function(b) {
    ...
    }(jQuery), window.initMapContact = function() {
        $(function() {
            var a = $("#map");
            if (a.on("contextmenu", function(a) {
                ...
                htmlInfo = "", infoContent = $(function() {
                    ...
                    return a.preventDefault(), !1
                })[0], ControlGetDirections = function(a, b, c) {
                    var d = $("<div />", {
                ...
                }, zz = 3, map = new google.maps.Map(document.getElementById("map"), {
                    zoom: zz,
                    center: d
                ...
                }).on("click", f), controlUI = null, setLL = 0, ii = 0, geocoder = new google.maps.Geocoder, initDefaultMarker = function() {
                    setTimeout(function() {
